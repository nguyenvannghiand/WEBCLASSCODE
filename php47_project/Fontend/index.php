<?php
	...
	//$action = Read
	//---
	//goi file Views/LayoutTrangChu.php de hien thi, load cac MVC vao file nay
	//co 2 file layout laf LayoutTrangTru vaf LayoutTrangTrong
	//-> neu khong co bien controller truyen len url thi hien thi LayoutTrangtru.php, nguoc lai hien thi LayoutTrangTrong
