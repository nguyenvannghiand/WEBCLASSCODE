<?php 
	...
	//co 2 file layout la LayoutTrangChu.php va LayoutTrangTrong.php -> neu khong co bien controller truyen len url thi hien thi LayoutTrangChu.php, nguoc lai hien thi LayoutTrangTrong.php
